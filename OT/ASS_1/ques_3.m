...
C=[5 -1]; %Cost of objective function
A=[1 1;2 5]; %Constraint Coeff. matrix
B=[2;8]; %R.H.S. of constraint
...
ylabel('Value of x2');
title('x1 vs x2');
legend('x1+x2\leq 2', '2x1+5x2\leq 8');
...
RKR=[0;0];
 ...
 PT=constraints_3(points); %calling constraint function file
 PT=unique(PT,'rows')
